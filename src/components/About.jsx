...
function AboutSection() {
  ...
  return (
    <section className="w-full bg-white">
      <div className=" h-[120vh] grid grid-cols-1 md:grid-cols-2 gap-18 items-center">
  ...
  />
        ...
        <img src="./foot.svg" className="h-12 mb-4"/>
          <p className="text-amber-500 uppercase tracking-wider font-medium mb-4">- ABOUT US -</p>

          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
            What Makes Us Care About Pets<span className="text-amber-500">.</span>
          </h2>

          <p className="text-gray-600 text-xl mb-6">Our love for animals drives everything we do.</p>
