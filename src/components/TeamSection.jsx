...
function TeamSection() {
  ...
  <div className="md:w-1/2 flex text-center flex-col justify-center">
    <h3 className="text-xl font-bold text-gray-800 mb-2">Emma Johnson</h3>
    ...
    />
            ...
            <div className="md:w-1/2 flex flex-col justify-center">
              <h3 className="text-xl font-bold text-gray-800 mb-2">David Smith</h3>
              <p className="text-amber-500 text-xs uppercase tracking-wider font-medium mb-4">VETERINARY SPECIALIST</p>
              <p className="text-gray-600 text-sm mb-6 text-center">
          ...
          <div className="flex flex-col text-center md:flex-row gap-8">
            ...
            <div className="md:w-1/2 flex flex-col justify-center">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Sophia Lee</h3>
  ...
  />
          ...
          <div className="flex flex-col text-center md:flex-row gap-8">
            ...
            <div className="md:w-1/2 flex flex-col justify-center">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Emma Brown</h3>
              <p className="text-amber-500 text-xs uppercase tracking-wider font-medium mb-4">VOLUNTEER MANAGER</p>
              <p className="text-gray-600 text-sm mb-6 text-center">
