...
<footer className="bg-[#292929] text-gray-300 py-10">
  <div className="container mx-auto px-4">
    ...
    <div className="flex flex-col md:flex-row flex-wrap py-16 justify-between">
      

      <div className="w-full md:w-[35%] px-4">
        <div className="flex items-center mb-4">
          <div className="">
             <img src="logow.png" className="h-15"/>
          </div>
          
        </div>
        <p className="text-sm mb-6">
          Join us in building a compassionate world where every pet is valued, nurtured, and finds a place to call their forever home.
        </p>
      </div>
      ...
      <div className="w-[30%] ">
        ...
        <ul className="space-y-2">
          <li><a href="#" className="hover:text-yellow-500 transition-colors">Pets</a></li>
          <li><a href="#" className="hover:text-yellow-500 transition-colors">About us</a></li>
          <li><a href="#" className="hover:text-yellow-500 transition-colors">How You Can Help</a></li>
        </ul>
      </div>
      ...
      <div className="w-full md:w-[30%]">
        ...
        <ul className="space-y-2">
          <li><a href="#" className="hover:text-yellow-500 transition-colors">Team</a></li>
          <li><a href="#" className="hover:text-yellow-500 transition-colors">Testimonials</a></li>
    ...
    <div className="flex flex-col md:flex-row justify-between border-t-2 border-gray-300 items-center pt-4">
      <div className="text-gray-300 font-bold text-xs ">© CREATED BY</div>
